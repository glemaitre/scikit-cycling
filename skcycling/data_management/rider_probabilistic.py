...
from ..probabilistic_power_profile import RideProbabilisticPowerProfile
from ..probabilistic_power_profile import RecordProbabilisticPowerProfile
from ..utils.checker import check_tuple_date


class RiderProbabilistic(object):
    ...
    rides_pp : list of RideProbabilisticPowerProfile or None, optional (default=None)
        Initialize the list of RideProbabilisticPowerProfile

    Attributes
    ----------
    rides_pp_ : list of RideProbabilisticPowerProfile
        The list of the ride power-profile linked to a rider.

    record_pp_ : RecordProbabilisticPowerProfile
    ...
    def __init__(self, cyclist_weight, max_duration_profile=300,
        ...
        self.record_pp_ = RecordProbabilisticPowerProfile(
    ...
    def _validate_rides_pp(self, rides_pp):
        ...
        Parameters
        ----------
        rides_pp : list of RideProbabilisticPowerProfile
        ...
        if isinstance(rides_pp, list):
            # Check that each element are from the class RideProbabilisticPowerProfile
            for rpp in rides_pp:
                if not isinstance(rpp, RideProbabilisticPowerProfile):
    ...
    def save_to_pickles(self, filename):
        """ Function to save an object RecordProbabilisticPowerProfile through pickles.
    ...
    def add_rides(self, location, overwrite=False, n_jobs=1):
        ...
        for filename in filenames:
            ...
            rpp = RideProbabilisticPowerProfile(
                max_duration_profile=self.max_duration_profile,
                cyclist_weight=self.cyclist_weight,
                n_jobs=n_jobs)
            rpp.fit(filename)
